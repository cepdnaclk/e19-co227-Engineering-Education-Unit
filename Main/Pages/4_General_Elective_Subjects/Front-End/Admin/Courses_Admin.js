...
import "./Courses_Admin.css"

class Courses_Not_Offered_Admin extends Component{
    state = {
        value: "Some text here",
        isInEditMode: false,
        code: "CoursesNotOffered"
    }
    componentDidMount() {
    axios.get("http://localhost:8080/gettext")
        .then(response => {
        const data = response.data;
        const subjectWithCodeHello = data.find(item => item.code === "CoursesNotOffered");
                ...
                <div className = "home-inner-container">
                    <div className = "info">
                        <textarea
                            ...
                            readOnly
                            />
                        <button style={{...buttonStyle}} onClick={this.changeEditMode}>Edit Course List</button>
                    </div>
...
export default Courses_Not_Offered_Admin;