...
class Alert_Course_Not_Offered_Admin extends Component{
    state = {
                ...
                <div className = "home-inner-container">
                    <div className = "info">
                        <textarea
                            ...
                            readOnly
                            />
                        <button style={{...buttonStyle}} onClick={this.changeEditMode}>Edit Alert Message</button>
                    </div>
...
export default Alert_Course_Not_Offered_Admin;