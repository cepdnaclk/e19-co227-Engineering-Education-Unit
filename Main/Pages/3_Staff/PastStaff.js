...
const App=()=>{
  ...
  <div class="card-body">
    ...
    <img src="../kam.png" width="50%" class="card-img-top" alt="Dr.(Eng.) Kamalanath Samarakoon"/> <br />
    <p class="card-text1">2012 to 2014 Dr. Gamunu Herath</p>
    <img src="../gam.jpg" width="50%" class="card-img-top" alt="Dr. Gamunu Herath"/>
    <p class="card-text1">20-- to 20-- Dr. Asanga Rathnaweera</p>
    <img src="../asanga.jpg" width="50%" class="card-img-top" alt="Dr. Asanga Rathnaweera"/>
    <p class="card-text1">20-- to 20-- Dr. Jayalath Edirisinghe</p>
    <img src="../edi.jpg" width="50%" class="card-img-top" alt="Dr. Jayalath Edirisinghe"/>
    <h4>Contributions</h4> 
...
<img src="../profnandalal.jpg" width="50%" class="card-img-top" alt="Prof. K.D.W. Nandalal"/><br />
...
<img src="../samuel.jpg" width="50%" class="card-img-top" alt="Prof. T.D.M.A. Samuel"/><br />
<h3>Teaching Assistants</h3>
<p>19 to 19-- Mr.Warnakulasoriya</p>
<h3>Audio Visual Technical Officers</h3>
<p>1996 to 19-- Mr.R.M.G Rathnayake</p>
<img src="../gamini.jpg" width="50%" class="card-img-top" alt="Mr.R.M.G Rathnayake"/><br />

<h3 class="card-title">Supporting Staff</h3>
<p>20-- to 20--Mr. A.M.P.G.S. Ekanayake</p>
<img src="../mr._a.m.p.g.s._ekanayake.jpg" width="50%" class="card-img-top" alt="Mr. A.M.P.G.S. Ekanayake"/>
